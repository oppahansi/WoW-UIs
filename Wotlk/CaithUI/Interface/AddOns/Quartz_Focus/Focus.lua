...
local startTime, endTime, delay, fadeOut, stopTime, casting, channeling, db, lastNotInterruptible
...
function QuartzFocus:UNIT_SPELLCAST_START(unit)
    ...
    local r,g,b = unpack(Quartz.db.profile.backgroundcolor)
...
do
	...
	function QuartzFocus:ApplySettings()
		...
		interruptBackdrop.edgeFile = media:Fetch('border', qpdb.border)
...
do
	...
	Quartz.options.args.Focus = {
		...
		args = {
            ...
            noInterruptGroup = {
                name = 'No interrupt cast bars',
                type = 'group',
                desc = 'No interrupt cast bars',
                args = {
                    border = {
                        type = 'text',
                        name = L["Border"],
                    ...
                    borderColor = {
                        ...
                        get = getcolor,
                        set = setcolor,
                        passValue = 'noInterruptBorderColor',
                        order = 2,
                    },
                    borderAlpha = {
                        type = 'range',
                        ...
                        get = get,
                        set = set,
                        passValue = 'noInterruptBorderAlpha',
                        order = 3,
                    },
                },
                order = 450,
