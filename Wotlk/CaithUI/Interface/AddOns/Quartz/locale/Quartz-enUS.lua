...
L:RegisterTranslations("enUS", function()
	return {
		...
		["Rank %s"] = true,
            ...
            --Target
            ["Set the border style for no interrupt casting bars"] = true,
            ["Set the color of the no interrupt casting bar border"] = true,
            ["Set the alpha of the no interrupt casting bar border"] = true,
	}
end)
