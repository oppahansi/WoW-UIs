...
DBM_CORE_DISABLED_ICON_FUNCTION		= "Your Mod no longer set icons, because of the outdated Version. Please update as soon as possible and reenable the the icon funcion."
