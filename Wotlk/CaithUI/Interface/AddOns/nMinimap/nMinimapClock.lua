...
local function Minimap_CreateDropDown()
    ...
    button[9].func = function() ToggleLFGParentFrame() end
...
TimeManagerClockTicker:SetFont('Fonts\\ARIALN.ttf', 16, 'OUTLINE')
TimeManagerClockTicker:SetShadowOffset(0, 0)
TimeManagerClockTicker:SetTextColor(color.r, color.g, color.b)
...
TimeManagerClockButton:SetPoint('BOTTOMLEFT', Minimap, 4, 5)
