...
L["Allows you to type messages longer than normal, and splits message that are too long."] = "允許你輸入正常的訊息長度，也可以分割太長的訊息。"
L["alt2"] = "alt2"
L["alt3"] = "alt3"
L["Alt-click name to invite"] = "使用Alt+左鍵邀請"
L["Alt Linking"] = "分身連結"
L["Alt note fallback"] = "依照分身註記"
L["Are you sure you want to delete all your saved class/level data?"] = "你確定要清空這些資料嗎？"
...
L["Enable"] = "啟用"
L["Enable "] = "啟用"
L["Enable borders on this frame"] = "為該框架啟用邊框"
L["Enabled"] = "已啟用"
...
L["Enables you to right-click a person's name in chat and set a note on them to be displayed in chat, such as their main character's name. Can also scan guild notes for character names to display, if no note has been manually set."] = "允許你右鍵點擊一個人的名字，設置一個在聊天視窗中顯示的註記，例如他們的本尊的名字。"
L["Enables you to set a custom font and font size for your chat frames"] = "允許你為聊天視窗自定義字型及大小"
...
L["Exclude level display for max level characters"] = "為最高等級的角色不顯示等級"
...
L["Left"] = "左"
L["Left Bracket"] = "左括號"
L["Lets you alt-click player names to invite them to your party."] = "你可用alt+點擊玩家名稱邀請加入你的隊伍。"
L["Lets you copy text out of your chat frames."] = "你可從聊天框中複製訊息。"
L["Lets you copy URLs out of chat."] = "你可從聊天框中複製網址。"
L["Lets you customize the position and look of the edit box"] = "允許你自定義輸入框的外觀和位置"
L["Lets you link items, enchants, spells, talents, achievements and quests in custom channels."] = "使你能夠在自定義頻道裡連結物品，附魔，法術以及任務。"
...
L["Lets you use the mousewheel to page up and down chat."] = "允許你使用滑鼠滾輪進行聊天記錄中捲動。"
...
L["Priest"] = "牧師"
L["Profiles"] = "設定檔"
L["Provides a /gr slash command to let you speak in your group (raid, party, or battleground) automatically."] = "允許你使用/gr命令自動依照你當前的隊伍情況，使用在對應的頻道（團隊，隊伍或者戰場）裡。"
