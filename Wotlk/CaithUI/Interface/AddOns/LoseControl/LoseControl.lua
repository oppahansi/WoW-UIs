...
local spellIds = {
	...
	[19263] = Silence,	-- Deterrence (Hunter)
	[47585] = Silence,	-- Dispersion (Priest)
	[871]   = Silence,	-- Shield Wall (Warrior)
	[33206] = Silence,	-- Pain Suppression (Priest)
	-- PvE
