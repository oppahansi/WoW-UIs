...
if TukuiCF["datatext"].battleground == true then
	...
	Text1:SetFont(TukuiCF.media.minimal, TukuiCF["datatext"].fontsize)
	...
	Text2:SetFont(TukuiCF.media.minimal, TukuiCF["datatext"].fontsize)
	...
	Text3:SetFont(TukuiCF.media.minimal, TukuiCF["datatext"].fontsize)
		...
		if int < 0 then
			...
			for i=1, numScores do
				...
				if healingDone > damageDone then
					dmgtxt = (hexa..tukuilocal.datatext_healing..hexb..healingDone)
				else
					dmgtxt = (hexa..tukuilocal.datatext_damage..hexb..damageDone)
				end
				if ( name ) then
					if ( name == UnitName("player") ) then
						Text2:SetText(hexa..tukuilocal.datatext_honor..hexb..honorGained)
						Text1:SetText(dmgtxt)
						Text3:SetText(hexa..tukuilocal.datatext_killingblows..hexb..killingBlows)
					end   
				end
			end 
			int  = 1
