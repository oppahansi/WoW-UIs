if TukuiDB.client == "ruRU" then
	...
	tukuilocal.core_welcome1 = "Добро пожаловать в |cffC495DDTukui|r Fix/ReEdit by Метаморфозис версии "
	...
	tukuilocal.databar_ms = "Пинг: "
	tukuilocal.databar_dura = "Броня: "
	
	tukuilocal.login = "Добро пожаловать в интерфейс от Гидры Fix/ReEdit by Метаморфозис, версия 2, "
end