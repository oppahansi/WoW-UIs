...
TukuiFonts:SetScript("OnEvent", function(self, event, addon)
	...
	local MINIF     = TukuiCF.media.minimal
	local COMBAT     = TukuiCF.media.dmgfont
	local NUMBER     = TukuiCF.media.minimal	
	...
	SetFont(NumberFont_OutlineThick_Mono_Small, NUMBER, 8)
	SetFont(NumberFont_Outline_Huge,            NUMBER, 10, "OUTLINE", 28)
	SetFont(NumberFont_Outline_Large,           NUMBER, 9, "OUTLINE")
	SetFont(NumberFont_Outline_Med,             NUMBER, 10, "OUTLINEMONOCHROME")
	...
	SetFont(SystemFont_Shadow_Small,            NORMAL, 11) -- Chat Tabs etc
