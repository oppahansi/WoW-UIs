...
if TukuiCF.actionbar.ingame then
...
if TukuiCF["actionbar"].bottomrows == 2 and TukuiCF["actionbar"].rightbars > 1 and not TukuiDB.lowversion and not TukuiCF.actionbar.lowversion then
...
if (IsAddOnLoaded("Dominos") or IsAddOnLoaded("RazerNaga") or IsAddOnLoaded("Bartender4") or IsAddOnLoaded("Macaroon")) then
