...
TukuiWatchFrame:SetScript("OnEvent", function(self, event, addon)
	if (addon == "Tukui") and (not IsAddOnLoaded("Who Framed Watcher Wabbit") or not IsAddOnLoaded("Fux")) then
		...
		wf:ClearAllPoints()
		wf:SetPoint("TOPRIGHT", UIParent, "TOPRIGHT", TukuiDB.Scale(-86), TukuiDB.Scale(-230))
		wf:SetHeight(600)
...
WorldStateAlwaysUpFrame:SetPoint("TOP", 0, TukuiDB.Scale(-130))