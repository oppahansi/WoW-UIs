...
for i=1, 12 do
	...
	b:ClearAllPoints()
	if i == 1 then
		if TukuiDB.lowversion and TukuiCF.actionbar.bottomrows == 2 or not TukuiDB.lowversion and TukuiCF.actionbar.lowversion and TukuiCF.actionbar.bottomrows == 2 then
...
if not TukuiDB.lowversion and not TukuiCF.actionbar.lowversion then
...
-- hide it if needed
if (TukuiCF.actionbar.bottomrows == 1 and TukuiDB.lowversion) or (not TukuiDB.lowversion and TukuiCF.actionbar.lowversion and TukuiCF.actionbar.bottomrows == 1) then
	TukuiBar2:Hide()
end