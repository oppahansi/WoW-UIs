...
for i= 1, 12 do
	...
	b:ClearAllPoints()
	if i == 1 then
		if TukuiCF.actionbar.rightbars > 2 or not TukuiDB.lowversion and TukuiCF.actionbar.lowversion and TukuiCF.actionbar.rightbars > 2 then
...
if not TukuiDB.lowversion and not TukuiCF.actionbar.lowversion and TukuiCF.actionbar.bottomrows == 2 then
...
-- hide it if needed
if (TukuiDB.lowversion and TukuiCF.actionbar.rightbars < 3) or (not TukuiDB.lowversion and TukuiCF.actionbar.bottomrows == 1 and TukuiCF.actionbar.rightbars < 3) or (not TukuiDB.lowversion and TukuiCF.actionbar.lowversion and TukuiCF.actionbar.rightbars < 3) then
	TukuiBar3:Hide()
end