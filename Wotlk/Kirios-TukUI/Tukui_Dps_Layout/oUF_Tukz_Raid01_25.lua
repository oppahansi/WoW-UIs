...
local font2 = TukuiCF["media"].minimal
...
local function Shared(self, unit)
	...
	self:SetAttribute('initial-height', TukuiDB.Scale(20*TukuiDB.raidscale))
...
oUF:Factory(function(self)
	...
	local raid = self:SpawnHeader("oUF_TukuiDpsRaid05101525", nil, "custom [@raid26,exists] hide;show", "showParty", true, "showPlayer", TukuiCF["unitframes"].showplayerinparty, "showRaid", true, "yOffset", TukuiDB.Scale(-4))
	raid:SetPoint('TOPLEFT', UIParent, 10, -350*TukuiDB.raidscale)
