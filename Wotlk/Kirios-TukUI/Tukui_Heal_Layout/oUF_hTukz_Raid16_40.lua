...
local function Shared(self, unit)
	...
	health.value:SetFont(font2, 10*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale, "THINOUTLINE")
	...
	name:SetFont(font1, 10*TukuiCF["unitframes"].gridscale*TukuiDB.raidscale)
