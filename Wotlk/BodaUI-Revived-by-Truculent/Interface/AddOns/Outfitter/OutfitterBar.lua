...
function Outfitter.OutfitBar:Construct()
	...
	if Outfitter.LBF and not Outfitter.LBFGroup then
		...
		if gOutfitter_Settings.LBFSettings then
			Outfitter.LBFGroup:Skin(gOutfitter_Settings.LBFSettings.SkinID, gOutfitter_Settings.LBFSettings.Gloss, gOutfitter_Settings.LBFSettings.Backdrop, gOutfitter_Settings.LBFSettings.Colors)
		end
	end
...
function Outfitter:LBFSkinCallback(pSkinID, pGloss, pBackdrop, pGroup, pButton, pColors)
	if not gOutfitter_Settings.LBFSettings then
		gOutfitter_Settings.LBFSettings = {}
	end
	
	gOutfitter_Settings.LBFSettings.SkinID = pSkinID
	gOutfitter_Settings.LBFSettings.Gloss = pGloss
	gOutfitter_Settings.LBFSettings.Backdrop = pBackdrop
	gOutfitter_Settings.LBFSettings.Colors = pColors
end
