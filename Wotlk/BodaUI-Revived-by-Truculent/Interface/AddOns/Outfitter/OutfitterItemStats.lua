...
function Outfitter._TankPointsStat:CompareOutfits(pOldOutfit, pNewOutfit, pStatParams)
	...
	for vInventorySlot, vItem in pairs(pNewOutfit.Items) do
	...
	pNewOutfit.TankPoints = self.TPData.tankPoints[self.TPSchool]
...
----------------------------------------
{
	...
	{
		{
			Name = "Melee TankPoints",
			School = "MELEE",
			FilterStats =
			{
				Outfitter:GetStatByID("ARMOR"),
				Outfitter:GetStatByID("DEFENSE_RATING"),
				Outfitter:GetStatByID("DODGE_RATING"),
				Outfitter:GetStatByID("PARRY_RATING"),
				Outfitter:GetStatByID("BLOCK_RATING"),
				Outfitter:GetStatByID("RESILIENCE_RATING"),
				Outfitter:GetStatByID("STA"),
				Outfitter:GetStatByID("HEALTH"),
			},
		},
...
----------------------------------------
Outfitter._HitSpellpowerStat =
----------------------------------------
{
	Name = "Hit-capped spellpower",
	ID = "HitCapSpell",
	MultiStatParams =
	{
		{Stat = Outfitter:GetStatByID("SPELL_HIT_RATING"), MinValue = 200},
		{Stat = Outfitter:GetStatByID("SPELL_DMG")},
	},
	FilterStats =
	{
		Outfitter:GetStatByID("SPELL_HIT_RATING"),
		Outfitter:GetStatByID("SPELL_DMG"),
	},
}

function Outfitter._HitSpellpowerStat:GetFilterStats()
	return self.FilterStats
end

function Outfitter._HitSpellpowerStat:CompareOutfits(pOldOutfit, pNewOutfit, pStatParams)
	return Outfitter:MultiStatCompare(pPreviousOutfit, pNewOutfit, self.MultiStatParams)
end

----------------------------------------
Outfitter.MultiStatCategory = 
----------------------------------------
{
	Name = "Multi-stat",
	CategoryID = "MultiStat",
	Stats =
	{
		Outfitter._HitSpellpowerStat,
	},
...
function Outfitter.MultiStatCategory:GetNumStats()
	return #self.Stats
end

function Outfitter.MultiStatCategory:GetIndexedStat(pIndex)
	return self.Stats[pIndex]
end

--table.insert(Outfitter.StatCategories, Outfitter.MultiStatCategory)
