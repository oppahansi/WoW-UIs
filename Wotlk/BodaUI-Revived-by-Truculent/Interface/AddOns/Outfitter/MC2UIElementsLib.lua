...
if not MCAddon.UIElementsLibTexturePath then
	MCAddon.UIElementsLibTexturePath = MCAddon.AddonPath
end

----------------------------------------
MCAddon.UIElementsLib._StretchTextures = {}
----------------------------------------

function MCAddon.UIElementsLib._StretchTextures:Construct(pTextureInfo, pFrame, pLayer)
...
----------------------------------------
MCAddon.UIElementsLib._PortaitWindow = {}
----------------------------------------

MCAddon.UIElementsLib._PortaitWindow.BackgroundTextureInfo =
{
	...
	BottomLeft   = {Width = 100, Height = 120, Path = MCAddon.UIElementsLibTexturePath.."Textures\\CalendarFrame-BottomLeft", Coords = {Left = 0, Right = 0.390625, Top = 0, Bottom = 0.9375}},
	BottomCenter = {Width = 156, Height = 120, Path = MCAddon.UIElementsLibTexturePath.."Textures\\CalendarFrame-BottomLeft", Coords = {Left = 0.390625, Right = 1, Top = 0, Bottom = 0.9375}},
	BottomRight  = {Width =  93, Height = 120, Path = MCAddon.UIElementsLibTexturePath.."Textures\\CalendarFrame-BottomRight", Coords = {Left = 0, Right = 0.7265625, Top = 0, Bottom = 0.9375}},
}

function MCAddon.UIElementsLib._PortaitWindow:New(pTitle, pWidth, pHeight, pName)
	return CreateFrame("Frame", pName, UIParent)
end

function MCAddon.UIElementsLib._PortaitWindow:Construct(pTitle, pWidth, pHeight, pName)
...
----------------------------------------
MCAddon.UIElementsLib._PanelSectionBackgroundInfo =
----------------------------------------
{
...
----------------------------------------
function MCAddon.UIElementsLib:SetDialogBackdrop(pFrame)
----------------------------------------
	pFrame:SetBackdrop(
	{
...
----------------------------------------
MCAddon.UIElementsLib._ModalDialogFrame = {}
----------------------------------------

function MCAddon.UIElementsLib._ModalDialogFrame:New(pParent, pTitle, pWidth, pHeight)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._ModalDialogFrame:Construct(pParent, pTitle, pWidth, pHeight)
...
----------------------------------------
MCAddon.UIElementsLib._SidebarWindowFrame = {}
----------------------------------------

function MCAddon.UIElementsLib._SidebarWindowFrame:New(pParent)
	return CreateFrame("Frame", nil, pParent or UIParent)
end

function MCAddon.UIElementsLib._SidebarWindowFrame:Construct()
	self:EnableMouse(true)
...
function MCAddon.UIElementsLib._Tabs:Construct(pFrame, pXOffset, pYOffset)
...
function MCAddon.UIElementsLib._Tabs:NewTab(pTitle, pValue)
...
function MCAddon.UIElementsLib._Tabs:UpdateTabs()
	local vPreviousTab
...
function MCAddon.UIElementsLib._Tabs:SelectTabByValue(pValue)
	self:SelectTab(self:GetTabByValue(pValue))
end

function MCAddon.UIElementsLib._Tabs:ShowTabByValue(pValue)
	self:ShowTab(self:GetTabByValue(pValue))
end

function MCAddon.UIElementsLib._Tabs:HideTabByValue(pValue)
	self:HideTab(self:GetTabByValue(pValue))
end

function MCAddon.UIElementsLib._Tabs:SelectTab(pTab)
...
function MCAddon.UIElementsLib._Tabs:ShowTab(pTab)
...
function MCAddon.UIElementsLib._Tabs:HideTab(pTab)
	if pTab.Hidden then
		return
	end
...
function MCAddon.UIElementsLib._Tabs:GetTabByValue(pValue)
...
function MCAddon.UIElementsLib._Tabs:Tab_OnClick(pTab, pButton)
	PlaySound("igMainMenuOpen")
	self:SelectTabByValue(pTab.Value)
end

----------------------------------------
MCAddon.UIElementsLib._TabbedView = {}
----------------------------------------

function MCAddon.UIElementsLib._TabbedView:New(pParent, pXOffset, pYOffset)
	return CreateFrame("Frame", nil, pParent or UIParent)
end

function MCAddon.UIElementsLib._TabbedView:Construct(pParent, pXOffset, pYOffset)
	self.Views = {}
...
function MCAddon.UIElementsLib._TabbedView:AddView(pFrame, pTitle)
	local vView =
	{
		Title = pTitle,
		Frame = pFrame,
...
function MCAddon.UIElementsLib._TabbedView:SelectView(pFrame)
...
function MCAddon.UIElementsLib._TabbedView:GetViewByFrame(pFrame)
...
function MCAddon.UIElementsLib._TabbedView:ShowView(pFrame)
	self.Tabs:ShowTabByValue(pFrame)
end

function MCAddon.UIElementsLib._TabbedView:HideView(pFrame)
	self.Tabs:HideTabByValue(pFrame)
end

function MCAddon.UIElementsLib._TabbedView:ActivateView(pView)
	if pView.ViewActivated then
		pView:ViewActivated()
	end
end

function MCAddon.UIElementsLib._TabbedView:DeactivateView(pView)
...
----------------------------------------
MCAddon.UIElementsLib._ScrollbarTrench = {}
----------------------------------------

function MCAddon.UIElementsLib._ScrollbarTrench:New(pParent)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._ScrollbarTrench:Construct(pParent)
	self:SetWidth(27)
...
----------------------------------------
MCAddon.UIElementsLib._Scrollbar = {}
----------------------------------------

function MCAddon.UIElementsLib._Scrollbar:New(pParent)
	return CreateFrame("Slider", nil, pParent)
end

function MCAddon.UIElementsLib._Scrollbar:Construct(pParent)
	self:SetWidth(16)
...
function MCAddon.UIElementsLib._Scrollbar:SetValue(...)
	self.Inherited.SetValue(self, ...)
	self:AdjustButtons()
end
	
function MCAddon.UIElementsLib._Scrollbar:SetMinMaxValues(...)
	self.Inherited.SetMinMaxValues(self, ...)
	self:AdjustButtons()
end

function MCAddon.UIElementsLib._Scrollbar:AdjustButtons()
...
----------------------------------------
MCAddon.UIElementsLib._ScrollingList = {}
----------------------------------------
...
function MCAddon.UIElementsLib._ScrollingList:New(pParent, pItemHeight)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._ScrollingList:Construct(pParent, pItemHeight)
...
function MCAddon.UIElementsLib._ScrollingList:GetOffset()
	return FauxScrollFrame_GetOffset(self.ScrollFrame)
end

function MCAddon.UIElementsLib._ScrollingList:GetNumVisibleItems()
	local vHeight = self:GetHeight() or 0
	return math.floor(vHeight / self.ItemHeight)
end

function MCAddon.UIElementsLib._ScrollingList:SetNumItems(pNumItems)
...
----------------------------------------
MCAddon.UIElementsLib._ScrollingItemList = {}
----------------------------------------

function MCAddon.UIElementsLib._ScrollingItemList:New(pParent, pItemMethods, pItemHeight)
	return Addon:New(Addon.UIElementsLib._ScrollingList, pParent, pItemHeight)
end

function MCAddon.UIElementsLib._ScrollingItemList:Construct(pParent, pItemMethods, pItemHeight)
	self.ItemMethods = pItemMethods
	self.ItemFrames = {}
end

function MCAddon.UIElementsLib._ScrollingItemList:GetNumVisibleItems()
...
function MCAddon.UIElementsLib._ScrollingItemList:SetNumItems(pNumItems)
...
----------------------------------------
MCAddon.UIElementsLib._CheckButton = {}
----------------------------------------

function MCAddon.UIElementsLib._CheckButton:New(pParent, pTitle)
	return CreateFrame("CheckButton", nil, pParent)
end

function MCAddon.UIElementsLib._CheckButton:Construct(pParent, pTitle)
	self.Enabled = true
...
function MCAddon.UIElementsLib._CheckButton:SetEnabled(pEnabled)
...
function MCAddon.UIElementsLib._CheckButton:SetAnchorMode(pMode)
...
function MCAddon.UIElementsLib._CheckButton:SetDisplayMode(pMode)
...
function MCAddon.UIElementsLib._CheckButton:SetChecked(pChecked)
...
function MCAddon.UIElementsLib._CheckButton:UpdateExpandModeTexture()
...
function MCAddon.UIElementsLib._CheckButton:UpdateLeaderModeTexture()
end

function MCAddon.UIElementsLib._CheckButton:SetTitle(pTitle)
	self.Title:SetText(pTitle)
end

function MCAddon.UIElementsLib._CheckButton:SetMultiSelect(pMultiSelect)
	self.MultiSelect = pMultiSelect
	self:SetDisplayMode(self.DisplayMode)
end

----------------------------------------
MCAddon.UIElementsLib._ExpandAllButton = {}
----------------------------------------

function MCAddon.UIElementsLib._ExpandAllButton:New(pParent)
	return Addon:New(Addon.UIElementsLib._CheckButton, pParent, ALL)
end

function MCAddon.UIElementsLib._ExpandAllButton:Construct(pParent)
	self:SetWidth(20)
	self:SetHeight(20)
...
----------------------------------------
MCAddon.UIElementsLib._Window = {}
----------------------------------------

function MCAddon.UIElementsLib._Window:New()
	return CreateFrame("Frame", nil, UIParent)
end

function MCAddon.UIElementsLib._Window:Construct()
	self:SetMovable(true)
	self:SetScript("OnDragStart", self.OnDragStart)
	self:SetScript("OnDragStop", self.OnDragStop)
end

function MCAddon.UIElementsLib._Window:OnDragStart()
	self:StartMoving()
end

function MCAddon.UIElementsLib._Window:OnDragStop()
	self:StopMovingOrSizing()
end

function MCAddon.UIElementsLib._Window:Close()
	self:Hide()
end

----------------------------------------
MCAddon.UIElementsLib._FloatingWindow = {}
----------------------------------------

function MCAddon.UIElementsLib._FloatingWindow:New()
	return Addon:New(Addon.UIElementsLib._Window)
end

function MCAddon.UIElementsLib._FloatingWindow:Construct()
...
function MCAddon.UIElementsLib._FloatingWindow:SetTitle(pTitle)
	self.TitleBar:SetTitle(pTitle)
end

function MCAddon.UIElementsLib._FloatingWindow:OnDragStart()
	self.Inherited.OnDragStart(self)
	self.TitleBar:SetForceFullBar(true)
end

function MCAddon.UIElementsLib._FloatingWindow:OnDragStop()
	self.Inherited.OnDragStop(self)
	self.TitleBar:SetForceFullBar(false)
end

----------------------------------------
MCAddon.UIElementsLib._PlainBorderedFrame = {}
----------------------------------------

function MCAddon.UIElementsLib._PlainBorderedFrame:New(pParent)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._PlainBorderedFrame:Construct(pParent)
	self:SetBackdrop(
	{
...
----------------------------------------
MCAddon.UIElementsLib._CloseButton = {}
----------------------------------------

function MCAddon.UIElementsLib._CloseButton:New(pParent)
	return CreateFrame("Button", nil, pParent)
end

function MCAddon.UIElementsLib._CloseButton:Construct(pParent)
	local vTexture
...
----------------------------------------
MCAddon.UIElementsLib._FadingTitleBar = {}
----------------------------------------

function MCAddon.UIElementsLib._FadingTitleBar:New(pParent)
	return CreateFrame("Button", nil, pParent)
end

function MCAddon.UIElementsLib._FadingTitleBar:Construct(pParent)
	self:SetHeight(15)
...
function MCAddon.UIElementsLib._FadingTitleBar:SetForceFullBar(pForce)
...
function MCAddon.UIElementsLib._FadingTitleBar:ShowFullBar(pShow)
...
function MCAddon.UIElementsLib._FadingTitleBar:UpdateFullBarVisibility()
...
function MCAddon.UIElementsLib._FadingTitleBar:SetTitle(pTitle)
	self.FullBar.Title:SetText(pTitle)
	self.CompactBar.Title:SetText(pTitle)
end

function MCAddon.UIElementsLib._FadingTitleBar:SetCloseFunc(pCloseFunc)
	self.FullBar.CloseButton:SetScript("OnClick", pCloseFunc)
	self.FullBar.CloseButton:Show()
end

----------------------------------------
MCAddon.UIElementsLib._ExpandButton = {}
----------------------------------------

function MCAddon.UIElementsLib._ExpandButton:New(pParent)
	return CreateFrame("Button", nil, pParent)
end

function MCAddon.UIElementsLib._ExpandButton:Construct(pParent)
	self:SetWidth(16)
	self:SetHeight(16)
...
function MCAddon.UIElementsLib._ExpandButton:SetExpanded(pExpanded)
	if pExpanded then
		self:SetNormalTexture("Interface\\Buttons\\UI-MinusButton-UP")
	else
		self:SetNormalTexture("Interface\\Buttons\\UI-PlusButton-UP")
...
----------------------------------------
MCAddon.UIElementsLib._DropDownMenuButton = {}
----------------------------------------
...
function MCAddon.UIElementsLib._DropDownMenuButton:New(pParent, pMenuFunc, pWidth)
...
function MCAddon.UIElementsLib._DropDownMenuButton:Construct(pParent, pMenuFunc, pWidth)
...
function MCAddon.UIElementsLib._DropDownMenuButton:SetMenuFunc(pMenuFunc)
end

function MCAddon.UIElementsLib._DropDownMenuButton:ToggleMenu()
	PlaySound("igMainMenuOptionCheckBoxOn")
...
function MCAddon.UIElementsLib._DropDownMenuButton:AddNormalItem(pText, pID, pIcon, pChecked, pDisabled)
...
function MCAddon.UIElementsLib._DropDownMenuButton:AddCategoryItem(pText)
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._DropDownMenuButton:AddChildMenu(pText, pID)
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._DropDownMenuButton:AddDivider()
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._DropDownMenuButton:ItemClicked(pValue)
...
function MCAddon.UIElementsLib._DropDownMenuButton:SetSelectedValue(pValue)
	-- Not applicable for a menu button
end

function MCAddon.UIElementsLib._DropDownMenuButton:GetSelectedValue()
	return self.selectedValue
end

function MCAddon.UIElementsLib._DropDownMenuButton:SetCurrentValueText(pText)
	-- Not applicable for a menu button
end

function MCAddon.UIElementsLib._DropDownMenuButton:SetEnabled(pEnabled)
	if pEnabled then
		self.Button:Enable()
		self:SetAlpha(1)
	else
...
function MCAddon.UIElementsLib._DropDownMenuButton:WoWMenuInitFunction(pLevel, pMenuList)
...
----------------------------------------
MCAddon.UIElementsLib._DropDownMenu = {}
----------------------------------------

for vName, vFunction in pairs(MCAddon.UIElementsLib._DropDownMenuButton) do
	MCAddon.UIElementsLib._DropDownMenu[vName] = vFunction
end

function MCAddon.UIElementsLib._DropDownMenu:Construct(pParent, pMenuFunc, pWidth)
...
function MCAddon.UIElementsLib._DropDownMenu:SetTitle(pTitle)
	self.Title:SetText(pTitle)
end

function MCAddon.UIElementsLib._DropDownMenu:SetCurrentValueText(pText)
	self.Text:SetText(pText)
end

function MCAddon.UIElementsLib._DropDownMenu:SetSelectedValue(pValue)
...
----------------------------------------
MCAddon.UIElementsLib._ContextMenu = {}
----------------------------------------

function MCAddon.UIElementsLib._ContextMenu:New(pParent)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._ContextMenu:Construct(pParent)
	UIDropDownMenu_Initialize(self, self.InitMenu)
end

function MCAddon.UIElementsLib._ContextMenu:ToggleMenu(pFrame)
	PlaySound("igMainMenuOptionCheckBoxOn")
...
function MCAddon.UIElementsLib._ContextMenu:InitMenu(pLevel, pMenuList)
	self:AddNormalItem("Test 1", "TEST1")
	self:AddNormalItem("Test 2", "TEST2")
	self:AddNormalItem("Test 3", "TEST3")
end

function MCAddon.UIElementsLib._ContextMenu:AddNormalItem(pText, pID, pIcon, pChecked, pDisabled)
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._ContextMenu:AddCategoryItem(pText)
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._ContextMenu:AddChildMenu(pText, pID)
	local vInfo = UIDropDownMenu_CreateInfo()
...
function MCAddon.UIElementsLib._ContextMenu:AddDivider()
	local vInfo = UIDropDownMenu_CreateInfo()
...
----------------------------------------
MCAddon.UIElementsLib._EditBox = {}
----------------------------------------

function MCAddon.UIElementsLib._EditBox:New(pParent, pLabel, pMaxLetters, pWidth, pPlain)
	return CreateFrame("EditBox", nil, pParent)
end

function MCAddon.UIElementsLib._EditBox:Construct(pParent, pLabel, pMaxLetters, pWidth, pPlain)
	self.Enabled = true
...
function MCAddon.UIElementsLib._EditBox:SetEnabled(pEnabled)
	self.Enabled = pEnabled
...
function MCAddon.UIElementsLib._EditBox:SetAnchorMode(pMode)
	self.Title:ClearAllPoints()
	self:ClearAllPoints()
...
function MCAddon.UIElementsLib._EditBox:EditFocusLost()
	self.HaveKeyboardFocus = nil
	self.TextHasChanged = nil
	self:HighlightText(0, 0)
end

function MCAddon.UIElementsLib._EditBox:EditFocusGained()
	self.HaveKeyboardFocus = true
	self.TextHasChanged = nil
	self:HighlightText()
end

function MCAddon.UIElementsLib._EditBox:SetAutoCompleteFunc(pFunction)
	self.AutoCompleteFunc = pFunction
end

function MCAddon.UIElementsLib._EditBox:OnChar()
...
function MCAddon.UIElementsLib._EditBox:OnCharComposition()
...
function MCAddon.UIElementsLib._EditBox:SetText(pText, ...)
	self.TextHasChanged = nil
...
function MCAddon.UIElementsLib._EditBox:OnTextChanged()
...
function MCAddon.UIElementsLib._EditBox:LinkIntoTabChain(pParent)
...
function MCAddon.UIElementsLib._EditBox:OnTabPressed()
...
function MCAddon.UIElementsLib._EditBox:SetVertexColor(pRed, pGreen, pBlue, pAlpha)
...
function MCAddon.UIElementsLib._EditBox:SetEmptyText(pText)
...
----------------------------------------
MCAddon.UIElementsLib._DatePicker = {}
----------------------------------------

function MCAddon.UIElementsLib._DatePicker:New(pParent, pTitle)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._DatePicker:Construct(pParent, pLabel)
	self.Enabled = true
...
function MCAddon.UIElementsLib._DatePicker:SetEnabled(pEnabled)
	self.Enabled = pEnabled
...
function MCAddon.UIElementsLib._DatePicker:SetDate(pMonth, pDay, pYear)
	if not pMonth then
...
function MCAddon.UIElementsLib._DatePicker:DateValueChanged()
	if self.ValueChangedFunc then
		self:ValueChangedFunc()
	end
end

function MCAddon.UIElementsLib._DatePicker:ValidateDay()
...
function MCAddon.UIElementsLib._DatePicker:GetDate()
	return self.MonthMenu:GetSelectedValue(), self.DayMenu:GetSelectedValue(), self.YearMenu:GetSelectedValue()
end

function MCAddon.UIElementsLib._DatePicker:MonthMenuFunc(pMenu)
	for vMonth = 1, 12 do
		pMenu:AddNormalItem(Addon.CALENDAR_MONTH_NAMES[vMonth], vMonth)
	end
end

function MCAddon.UIElementsLib._DatePicker:DayMenuFunc(pMenu)
	local vNumDays = Addon.DateLib:GetDaysInMonth(self.MonthMenu:GetSelectedValue(), self.YearMenu:GetSelectedValue())
...
function MCAddon.UIElementsLib._DatePicker:YearMenuFunc(pMenu)
...
function MCAddon.UIElementsLib._DatePicker:SetLabel(pLabel)
	self.LeftMenu:SetTitle(pLabel)
end

----------------------------------------
MCAddon.UIElementsLib._TimePicker = {}
----------------------------------------

function MCAddon.UIElementsLib._TimePicker:New(pParent, pTitle)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._TimePicker:Construct(pParent, pLabel)
	self.Enabled = true
...
function MCAddon.UIElementsLib._TimePicker:SetEnabled(pEnabled)
	self.Enabled = pEnabled
...
function MCAddon.UIElementsLib._TimePicker:SetTime(pHour, pMinute)
	local vHour
...
function MCAddon.UIElementsLib._TimePicker:TimeValueChanged()
	if self.ValueChangedFunc then
		self:ValueChangedFunc()
	end
end

function MCAddon.UIElementsLib._TimePicker:GetTime()
	local vHour, vMinute
...
function MCAddon.UIElementsLib._TimePicker:HourMenuFunc(pMenu)
...
function MCAddon.UIElementsLib._TimePicker:MinuteMenuFunc(pMenu)
	for vMinute = 0, 59, 5 do
		pMenu:AddNormalItem(string.format("%02d", vMinute), vMinute)
	end
end

function MCAddon.UIElementsLib._TimePicker:AMPMMenuFunc(pMenu)
	pMenu:AddNormalItem("AM", "AM")
	pMenu:AddNormalItem("PM", "PM")
end

function MCAddon.UIElementsLib._TimePicker:SetLabel(pLabel)
	self.HourMenu:SetTitle(pLabel)
end

----------------------------------------
MCAddon.UIElementsLib._LevelRangePicker = {}
----------------------------------------

function MCAddon.UIElementsLib._LevelRangePicker:New(pParent, pLabel)
	return CreateFrame("Frame", nil, pParent)
end

function MCAddon.UIElementsLib._LevelRangePicker:Construct(pParent, pLabel)
	self.Enabled = true
...
function MCAddon.UIElementsLib._LevelRangePicker:SetEnabled(pEnabled)
	self.Enabled = pEnabled
...
function MCAddon.UIElementsLib._LevelRangePicker:SetLabel(pLabel)
	self.MinLevel:SetTitle(pLabel)
end

function MCAddon.UIElementsLib._LevelRangePicker:SetLevelRange(pMinLevel, pMaxLevel)
	self.MinLevel:SetText(pMinLevel or "")
	self.MaxLevel:SetText(pMaxLevel or "")
end

function MCAddon.UIElementsLib._LevelRangePicker:GetLevelRange()
	return tonumber(self.MinLevel:GetText()), tonumber(self.MaxLevel:GetText())
end

function MCAddon.UIElementsLib._LevelRangePicker:ClearFocus()
	self.MinLevel:ClearFocus()
	self.MaxLevel:ClearFocus()
end

----------------------------------------
MCAddon.UIElementsLib._PushButton = {}
----------------------------------------

function MCAddon.UIElementsLib._PushButton:New(pParent, pTitle, pWidth)
	return CreateFrame("Button", nil, pParent)
end

function MCAddon.UIElementsLib._PushButton:Construct(pParent, pTitle, pWidth)
...
function MCAddon.UIElementsLib._PushButton:SetEnabled(pEnabled)
...
function MCAddon.UIElementsLib._PushButton:SetTitle(pTitle)
	self.Text:SetText(pTitle)
end

function MCAddon.UIElementsLib._PushButton:Enable()
	self.Inherited.Enable(self)
	self:UpdateButtonTexture()
end

function MCAddon.UIElementsLib._PushButton:Disable()
	self.Inherited.Disable(self)
	self:UpdateButtonTexture()
end

function MCAddon.UIElementsLib._PushButton:IsEnabled()
	return self.Inherited.IsEnabled(self) == 1
end

function MCAddon.UIElementsLib._PushButton:UpdateButtonTexture()
...
function MCAddon.UIElementsLib._PushButton:SetTextColor(pRed, pGreen, pBlue, pAlpha)
	self.Text:SetTextColor(pRed, pGreen, pBlue, pAlpha)
end

----------------------------------------
MCAddon.UIElementsLib._ScrollingEditBox = {}
----------------------------------------

function MCAddon.UIElementsLib._ScrollingEditBox:New(pParent, pLabel, pMaxLetters, pWidth, pHeight)
	return CreateFrame("Frame", nil, pParent)
end

MCAddon.UIElementsLib._ScrollingEditBox.InputFieldTextureInfo =
{
...
function MCAddon.UIElementsLib._ScrollingEditBox:Construct(pParent, pLabel, pMaxLetters, pWidth, pHeight)
	self.Enabled = true
...
function MCAddon.UIElementsLib._ScrollingEditBox:SetEnabled(pEnabled)
	self.Enabled = pEnabled
...
function MCAddon.UIElementsLib._ScrollingEditBox:GetText()
	return self.EditBox:GetText()
end

function MCAddon.UIElementsLib._ScrollingEditBox:SetText(pText)
	self.EditBox:SetText(pText)
end

function MCAddon.UIElementsLib._ScrollingEditBox:ShowLimitText()
...
function MCAddon.UIElementsLib._ScrollingEditBox:UpdateLimitText()
...
function MCAddon.UIElementsLib._ScrollingEditBox:ClearFocus()
	self.EditBox:ClearFocus()
end

----------------------------------------
MCAddon.UIElementsLib._ProgressBar = {}
----------------------------------------

function MCAddon.UIElementsLib._ProgressBar:New(pParent)
	return CreateFrame("StatusBar", nil, pParent)
end

function MCAddon.UIElementsLib._ProgressBar:Construct()
	self:SetHeight(20)
...
function MCAddon.UIElementsLib._ProgressBar:SetText(pText)
	self.LabelText:SetText(pText)
end

function MCAddon.UIElementsLib._ProgressBar:SetProgress(pProgress)
	if pProgress then
