...
local font, fontSize, fontOutline = [=[Interface\Addons\caelNamePlates\media\Accidental Presidency.ttf]=], 11, "OUTLINE"
local backdrop = {
...
local UpdateFrame = function(self)
	...
	self.healthBar:SetHeight(4.5)
	self.healthBar:SetWidth(85)

	self.castBar:ClearAllPoints()
	self.castBar:SetPoint("TOP", self.healthBar, "BOTTOM", 0, -4)
	self.castBar:SetHeight(3)
	self.castBar:SetWidth(85)
