			...
			["Triggers"] = {
				...
				["MSBT_TRIGGER_HAND_OF_JUSTICE"] = {
					...
					["TriggerSettings"] = {
						["TriggerType"] = 6,
						["SearchPatterns"] = {
							[1] = "Vous gagnez %d attaques supplémentaires grâce à Main de justice",
						},
						["TriggerEvents"] = {
				...
				["MSBT_TRIGGER_NIGHTFALL"] = {
					...
					["TriggerSettings"] = {
						...
						["TriggerType"] = 6,
						["SearchPatterns"] = {
							[1] = "Vous gagnez Transe de l'ombre",
						},
						["TriggerEvents"] = {
							[1] = "CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS",
						},
				...
				["MSBT_TRIGGER_WINDFURY"] = {
					...
					["TriggerSettings"] = {
						["TriggerType"] = 6,
						["SearchPatterns"] = {
							[1] = "Vous gagnez %d attaques supplémentaires grâce à Arme Furie-des-vents",
						},
						["TriggerEvents"] = {
							[1] = "CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS",
						},
