...
DFM_Settings = {
	...
	["Motrax :: Emerald Dream [1x] Blizzlike"] = "Default",
	["INITIALIZED1.0"] = 1,
	["LoadOnDemandFunctions"] = {
		[1] = "AuctionFrame_LoadUI",
		[2] = "BattlefieldMinimap_LoadUI",
		[3] = "ClassTrainerFrame_LoadUI",
		[4] = "CraftFrame_LoadUI",
		[5] = "InspectFrame_LoadUI",
		[6] = "KeyBindingFrame_LoadUI",
		[7] = "MacroFrame_LoadUI",
		[8] = "RaidFrame_LoadUI",
		[9] = "TalentFrame_LoadUI",
		[10] = "TradeSkillFrame_LoadUI",
	},
}
DFM_Initialized = {
	["Default"] = {
