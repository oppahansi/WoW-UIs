...
function PerformanceFu:OnTooltipUpdate()
	...
	local r, g, b = Crayon:GetThresholdColor(currentMemory, 5120000, 4096000, 3052000, 2048000, 102400)
	cat:AddLine(
	...
	r, g, b = Crayon:GetThresholdColor(initialMemory, 5120000, 4096000, 3052000, 2048000, 102400)
	cat:AddLine(
	...
	r, g, b = Crayon:GetThresholdColor(currentRate, 3000, 1000, 300, 100, 0)
	cat:AddLine(
	...
	r, g, b = Crayon:GetThresholdColor(averageRate, 3000, 1000, 300, 100, 0)
	cat:AddLine(
	...
	local r, g, b = Crayon:GetThresholdColor(gcThreshold, 5120000, 4096000, 3052000, 2048000, 10240)
	cat:AddLine(
		'text', L"Threshold:",
