...
["texture"] = "TempleofAhnQiraj",
		["infoline"] = "Im Herzen Ahn’Quirajs liegt ein uralter Tempelkomplex. Vor Beginn der Zeitrechnung erbaut, ist es ein Monument scheu\195\159licher Gottheiten und die gewaltige Brutst\195\164tte der Qiraji Streitmacht. Seit der Krieg der wehenden Sande vor tausend Jahren endete, waren die Zwilingsimperatoren von Ahn’Qiraj, Vek’nilash und Vek’lor, in ihrem Tempel gefangen. Die magische Barriere des bronzenen Drachen Anachronos und der Nachtelfen hielt sie in ihrem Bann. Doch nun, da das Szepter der Sandst\195\188rme wieder vereint und das Siegel gebrochen ist, steht der Weg in das Heiligtum Ahn’Qirajs erneut offen. Hinter dem krabbelnden Wahnsinn des Schwarmbaus, unter dem Tempel von Ahn’Quiraj, bereiten sich Heerscharen der Quiraji auf den Einmarsch vor. Nun gilt es, sie um jeden Preis aufzuhalten bevor sie ihre uners\195\164ttlichen, insektenartigen Armeen erneut auf auf Kalimdor loslassen und ein zweiter Krieg der Silithiden beginnt!",
},
[29] = {
["ZoneName"] = "Ruins of Ahn'Quiraj",
["Location"] = "Silithus",
["LevelRange"] = "60+",
["PlayerLimit"] = "20",
