...
function DL_Get_Health(unit)
	local health;
	if (MobHealth3) then
		health = MobHealth3:GetUnitHealth(unit);
	elseif (unit == "target" and MobHealth_GetTargetCurHP) then
...
function DL_Get_HealthMax(unit)
	local healthmax;
	if (MobHealth3) then
		_, healthmax = MobHealth3:GetUnitHealth(unit);
	elseif (unit == "target" and MobHealth_GetTargetMaxHP and UnitHealth(unit) > 0) then
