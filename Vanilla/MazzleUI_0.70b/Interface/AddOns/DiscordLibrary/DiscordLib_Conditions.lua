DL_CONDITIONS_MENU = {
	...
	{ text="Zone Is", value=79, params=12, desc="Used to check if you're in a certain zone." },
	{ text="Zone Isn't", value=80, params=12, desc="Used to check if you're not in a certain zone." },
}
