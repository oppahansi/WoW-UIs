...
function FuBar_NameToggle:OnTooltipUpdate()
	...
	cat:AddLine(
		...
		"text2", FRIENDNAMEPLATES_ON and L["tipshown"] or L["tiphidden"],
		"func", "ToggleFriendlyNamePlates",
		"arg1", self
	)
...
function FuBar_NameToggle:ToggleFriendlyNamePlates()
