  ...
  Recap 3.32-p1 (modified by Rophy from the original 3.32 version)
	
This AddOn will track and summarize the damage dealt and received by every participant in a fight around the user.


__ Changes in 3.32-p3 __

- Fixed typo on partial block check.

__ Changes in 3.32-p2 __

- Fixed typo in .toc  for Error: Recap.lua:7: attempt to index global `ParserLib' (a nil value)
- Death count wasn't working.
- Option panel shows minor version.
- Removed "Recap is not localized." warning message.

__ Changes in 3.32-p1 __

- Now uses ParserLib as the core combat parser.
