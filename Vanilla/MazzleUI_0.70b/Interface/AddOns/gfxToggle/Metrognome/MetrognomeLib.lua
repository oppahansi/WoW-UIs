...
local vmajor, vminor = "1", tonumber(string.sub("$Revision: 1288 $", 12, -3))
...
function lib:Register(name, func, rate, arg)
	...
	t.name, t.func, t.rate, t.arg = name, func, rate or 0, arg
...
function lib:Unregister(a1,a2,a3,a4,a5,a6,a7,a8,a9)
	...
	if a2 then self:Unregister(a2,a3,a4,a5,a6,a7,a8,a9)
...
-- This will also reset the timer's elapsed time to 0 and clear profile data
...
function lib:ChangeRate(name, newrate, n2,r2,n3,r3,n4,r4,n5,r5)
	...
	t.elapsed, t.count, t.mem, t.time = 0, 0, 0, 0
	t.rate = newrate or 0
