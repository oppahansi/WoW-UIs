...
local MINOR_VERSION = tonumber((string.gsub("$Revision: 14739 $", "^.-(%d+).-$", "%1")))
...
FuBar = AceLibrary("AceAddon-2.0"):new("AceDB-2.0", "AceConsole-2.0", "AceEvent-2.0", "AceHook-2.1")
local FuBar = FuBar
FuBar.title = "FuBar"
FuBar.version = MAJOR_VERSION .. "." .. MINOR_VERSION
FuBar.date = string.gsub("$Date: 2006-10-21 21:22:26 -0400 (Sat, 21 Oct 2006) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
...
FuBar:RegisterChatCommand(L["ChatCommands"], optionsTable)
