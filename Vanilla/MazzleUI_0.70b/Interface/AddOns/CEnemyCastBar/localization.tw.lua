...
if ( GetLocale() == "zhTW" ) then
    ...
    CEnemyCastBar_Spells = {
        ...
        ["星火術"] =      {t=3.5, icontex="Spell_Arcane_StarFire"};
        ["憤怒"] =        {t=2.0, icontex="Spell_Nature_AbolishMagic"};
	...
	--["The Beast Within"] = {t=18, d=120, icontex=""}; -- gain, Talent
        ...
        ["幽魂之狼"] = {t=3.0, icontex="Spell_Nature_SpiritWolf"};
    ...
    CEnemyCastBar_Raids = {
        ...
        -- Naxxramas
            ...
            -- Patchwerk
            [CECB_SPELL_ENRAGED_MODE] = {t=420, c="cooldown", icontex="Spell_Shadow_UnholyFrenzy"}; -- don't translate, used internally!
        ...
        -- Ahn'Qiraj
            ...
            -- 40 Man
                ...
                [CECB_SPELL_ENRAGED_MODE] = {t=900, r="沙爾圖拉 哈卡", a=600, c="cooldown", icontex="Spell_Shadow_UnholyFrenzy"}; -- don't translate, used internally! +if player enters combat and target are twins!
    ...
    -- blockZone="ZoneName" blocks the spell for the specified Zone (example: blockZone="Ahn'Qiraj" for 'Entangling Roots')
        ...
        ["悶棍"] = {t=45, plevel={10, 48, 28, 0}, fragile="true", spellDR="true", sclass="ROGUE", drshare="悶棍, 鑿擊", icontex="Ability_Sap"};
            ["腎擊"] = {t=6, cpinterval=1, solo="true", stuntype="true", spellDR="true", sclass="ROGUE", affmob="true", icontex="Ability_Rogue_KidneyShot"}; -- own DR
            ...
            -- periodic damage spells
                ...
                ["割裂"] = {t=16, cpinterval=2, periodicdmg="true", icontex="Ability_Rogue_Rupture"};
        ...
        ["休眠"] = {t=40, plevel={10, 58, 38, 0}, fragile="true", icontex="Spell_Nature_Sleep"};
            ["重擊"] = {t=4, tskill={2, 4, 0.5, "DRUID", 0}, solo="true", stun="true", icontex="Ability_Druid_Bash"};
            ["突襲"] = {t=2, tskill={2, 4, 0.5, "DRUID", 0}, solo="true", stun="true", icontex="Ability_Druid_SupriseAttack"};
            ["野性衝鋒效果"] = {t=4, solo="true", stun="true", icontex="Ability_Hunter_Pet_Bear"};
