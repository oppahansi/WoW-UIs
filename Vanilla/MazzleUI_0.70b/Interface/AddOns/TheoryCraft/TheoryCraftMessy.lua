...
--		Print("("..round(normalized).."+"..returndata["mindamage"]..")*"..returndata["backstabmult"].."+"..returndata["addeddamage"]..")*"..baseincrease)
		returndata["mindamage"] = ((normalized+returndata["mindamage"])*returndata["backstabmult"] + returndata["addeddamage"])*baseincrease + TheoryCraft_GetStat("AmmoDPS")*TheoryCraft_GetStat("RangedSpeed")
		returndata["maxdamage"] = ((normalized+returndata["maxdamage"])*returndata["backstabmult"] + returndata["addeddamage"])*baseincrease + TheoryCraft_GetStat("AmmoDPS")*TheoryCraft_GetStat("RangedSpeed")
		...
		if TheoryCraft_Data.EquipEffects["ShieldEquipped"] then
			blocktext = round(TheoryCraft_GetStat("BlockValue"))
		end
		for k, pattern in pairs(a) do
