...
--			Schools={ } },
	...
	["DRUID"] = {
		...
		{ id="Regrowth", level1=12, level2=18, percent=0.325, percentdot=0.513, dodps=1, isheal=1, cancrit=1, hasdot=1, tickinterval=3, talentsbeforegear=1, 
			Schools={ "All", "Healing", "Restoration" } },
		{ id="Starfire", percent=1, dodps=1, cancrit=1,
			Schools={ "All", "Damage", "Arcane", "Vengeance" } },
		{ id="Wrath", level1=1, level1per=1.5/2, level2=6, level2per=1.7/2, level3=14, percent=2/3.5, dodps=1, cancrit=1,
		...
		{ id="Entangling Roots", level1=8, level2=18, percent=1.5/3.5*0.75, dodps=1, dontdomax=1, basedotduration=24, isdot=1, tickinterval=3,
			Schools={ "All", "Damage", "Nature" } },
		{ id="Moonfire", level1=4, level2=10, level3=16, percent=0.2, percentdot=2/3.5, dodps=1, cancrit=1, hasdot=1, tickinterval=3,
			Schools={ "All", "Damage", "Arcane", "Vengeance" } },
		{ id="Hurricane", percent=0.03, dodps=1, casttime=1, regencasttime=1, manamultiplier=1/10, tickinterval=1, dontdomax=1,
			Schools={ "All", "Damage", "Nature" } },
