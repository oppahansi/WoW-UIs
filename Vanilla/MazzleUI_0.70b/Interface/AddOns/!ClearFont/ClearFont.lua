-- =============================================================================
--  CLEARFONT BY KIRKBURN  v11100-3 (fontless)
...
-------------------------------------------------------
   ...
   if (CanSetFont(GameFontDisable)) then 		SystemFont:SetFont(CLEAR_FONT, 13 * CF_SCALE); end
...
-- CombatTextFont: in-built SCT-style info (1.12 only)
------------------------------------------------------
...
----------------------------------------------------
   ...
   if (CanSetFont(QuestFont)) then 		   		QuestFont:SetFont(CLEAR_FONT_ITALIC, 14 * CF_SCALE); end
   if (CanSetFont(QuestFont)) then 		   		QuestFont:SetTextColor(0.15, 0.09, 0.04); end

   if (CanSetFont(QuestFontNormalSmall)) then 		QuestFontNormalSmall:SetFont(CLEAR_FONT_BOLD, 13 * CF_SCALE); end
   if (CanSetFont(QuestFontNormalSmall)) then 		QuestFontNormalSmall:SetShadowColor(0.54, 0.4, 0.1); end

   if (CanSetFont(QuestFontHighlight)) then 		QuestFontHighlight:SetFont(CLEAR_FONT, 15 * CF_SCALE); end
...
-----------
   ...
   if (CanSetFont(GameTooltipText)) then 	   		GameTooltipText:SetFont(CLEAR_FONT, 13 * CF_SCALE); end
