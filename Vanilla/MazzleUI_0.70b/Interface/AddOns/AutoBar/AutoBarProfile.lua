...
function AutoBarProfile.InitializeBasic()
	...
	AutoBarProfile.basic[11] = { "FOOD_PERCENT_COMBO", "FOOD_WATER", "FOOD_ARATHI", "FOOD_WARSONG" };
...
function AutoBarProfile.InitializeClass()
	...
	AutoBarProfile.ROGUE[FOODSLOT] = { "FOOD_STRENGTH", "FOOD_AGILITY", "FOOD_STAMINA", "FOOD_HPREGEN", "FOOD_PERCENT_BONUS" };
	...
	AutoBarProfile.DRUID[FOODSLOT] = { "FOOD_STRENGTH", "FOOD_AGILITY", "FOOD_STAMINA", "FOOD_INTELLIGENCE", "FOOD_HPREGEN", "FOOD_MANAREGEN", "FOOD_PERCENT_BONUS" };
...
function AutoBarProfile.ConvertSlots(profileName)
	...
	for buttonIndex = 1, AUTOBAR_MAXBUTTONS, 1 do
		...
		for i = 1, table.getn(slotInfo), 1 do
