--[[
Name: Babble-Zone-2.1
Revision: $Rev: 14620 $
Author(s): eternally777 (eternally777@gmail.com)
Based On: BabbleLib-2.0 by ckknight
Website: http://www.wowace.com/index.php/Babble-Zone-2.1
Documentation: http://www.wowace.com/index.php/Babble-Zone-2.1
SVN: http://svn.wowace.com/root/trunk/BabbleLib/BabbleLib-2.1/Babble-Zone-2.1
Description: A library to provide localizations for zones.
Dependencies: AceLibrary, AceLocale-2.1
]]

local MAJOR_VERSION = "Babble-Zone-2.1"
...
if AceLocale:HasInstance(MAJOR_VERSION) then
    BabbleZone = AceLocale:GetInstance(MAJOR_VERSION)
    if not BabbleZone:NeedsUpgrade(MINOR_VERSION) then return end
    BabbleZone:ClearLocales()
end
...
BabbleZone = AceLocale:GetInstance(MAJOR_VERSION, true)
BabbleZone:SetStrictness(true)

function BabbleZone:NeedsUpgrade(revision)
