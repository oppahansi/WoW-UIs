--[[
Name: Babble-Boss-2.1
Revision: $Revision: 13630 $
Author(s): eternally777 (eternally777@gmail.com)
Based On: BabbleLib-2.0 by ckknight
Website: http://www.wowace.com/index.php/Babble-Boss-2.1
Documentation: http://www.wowace.com/index.php/Babble-Boss-2.1
SVN: http://svn.wowace.com/root/trunk/BabbleLib/BabbleLib-2.1/Babble-Boss-2.1
Description: A library to provide localizations for bosses.
Dependencies: AceLibrary, AceLocale-2.1
]]

local MAJOR_VERSION = "Babble-Boss-2.1"
...
if AceLocale:HasInstance(MAJOR_VERSION) then
    BabbleBoss = AceLocale:GetInstance(MAJOR_VERSION)
    if not BabbleBoss:NeedsUpgrade(MINOR_VERSION) then return end
    BabbleBoss:ClearLocales()
end
...
AceLocale:RegisterTranslation(MAJOR_VERSION, "frFR", function()
	return {
		...
		["Lieutenant General Andorov"] = "Lieutenant Général Andorov",
		["The Bug Family"] = "La famille insecte", -- Translated twice?
		...
		["Deathknight Understudy"] = "Deathknight Understudy", -- CHECK
		...
		["Broodlord Lashlayer"] = "Seigneur des couvées Lashlayer",
		["Chromaggus"] = "Chromaggus",
		["Ebonroc"] = "Rochébène", -- CHECK
		...
		["General Rajaxx"] = "Général Rajaxx", -- CHECK
		["Lieutenant General Andorov"] = "Lieutenant-Général Andorov", -- CHECK
		["Moam"] = "Moam", -- CHECK
		["Anubisath Guardian"] = "Gardien Anubisath", -- CHECK
		["Ossirian the Unscarred"] = "Ossirian l'Intouché", -- CHECK
		["Lord Kri"] = "Seigneur Kri", -- CHECK
		["Princess Yauj"] = "Princesse Yauj", -- CHECK
		["Vem"] = "Vem", -- CHECK
		["The Bug Family"] = "The Bug Family", -- CHECK -- Translated twice?
		["Eye of C'Thun"] = "Oeil de C'Thun", -- CHECK
		["C'Thun"] = "C'Thun", -- CHECK
		["Anubisath Defender"] = "Défenseur Anubisath", -- CHECK
		...
		["The Prophet Skeram"] = "Le Prophète Skeram", -- CHECK
		["Emperor Vek'lor"] = "Empereur Vek'lor", -- CHECK
		["Emperor Vek'nilash"] = "Empereur Vek'nilash", -- CHECK
		["The Twin Emperors"] = "Empereurs jumeaux", -- CHECK
		...
		["Fineous Darkvire"] = "Fineous Darkvire",
		["Gasher"] = "Gasher",
		["General Angerforge"] = "Général Angerforge",
...
AceLocale:RegisterTranslation(MAJOR_VERSION, "koKR", function()
	return {
		["Avalanchion"] = "Avalanchion", -- check
		["The Windreaver"] = "The Windreaver", -- check
		["Baron Charr"] = "Baron Charr", -- check
		["Princess Tempestria"] = "Princess Tempestria", -- check
...
BabbleBoss = AceLocale:GetInstance(MAJOR_VERSION, true)
BabbleBoss:SetStrictness(true)

function BabbleBoss:NeedsUpgrade(revision)
