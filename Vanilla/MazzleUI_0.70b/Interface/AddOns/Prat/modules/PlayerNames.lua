...
L:RegisterTranslations("zhCN", function() return {
    ...
    ["Class"] = "职业",
    ["Random"] = "随机",
	["Sets style of brackets to use around player names."] = "设置玩家姓名的括号。",
	["Use common color"] = "使用特殊颜色",
    ["Toggle useing common color for unknown player names."] = "未知玩家姓名是否使用特殊颜色",
    ["Set common color"] = "设置特殊颜色",
    ["Change the common color of PlayerNames"] = "改变玩家姓名的特殊颜色",
	["Use TabComplete"] = "标签",
	...
	["Color Mode"] = "颜色模块",
	["How to color Players name."] = "玩家姓名颜色。",
	["Toggle"] = "切换",
