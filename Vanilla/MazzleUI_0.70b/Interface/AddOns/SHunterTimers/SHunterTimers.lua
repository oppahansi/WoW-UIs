...
Version 1.6.13 (by Kharthus of Deathwing)
...
function SHunterTimers_SlashCmd(msg)
	...
	elseif( string.find(msg, "down") ) then
		...
		SHunterTimersFrame:SetPoint( "TOPLEFT", "SHunterTimersAnchor", "BOTTOMLEFT" );
		DEFAULT_CHAT_FRAME:AddMessage("SHT: Growing down");
	elseif( string.find(msg, "up" ) ) then
		SHTvars["down"] = false;
		SHunterTimersFrame:ClearAllPoints();
		SHunterTimersFrame:SetPoint( "BOTTOMLEFT", "SHunterTimersAnchor", "TOPLEFT" );
...
function SHunterTimers_UpdateSpells()
	...
	SHTvars["textures"][SHT_SWARMGUARD] = "Interface\\Icons\\INV_Misc_AhnQirajTrinket_04";
