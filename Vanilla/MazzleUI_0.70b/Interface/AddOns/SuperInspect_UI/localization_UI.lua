...
if (GetLocale() == "enUS") then
	...
	SI_TEXT_CACHEPLAYERRANGE = "Need aprox. 10 Yards to inspect.";
	SI_TEXT_NAME = "Name";
	SI_TEXT_LVL = "Lvl";
	...
	if (SI_RunningWoW2) then	
		SI_IB_BLOCK = "Block rating";
		SI_IB_DODGE = "Dodge rating";
		SI_IB_PARRY = "Parry rating";
		SI_IB_CRIT = "Crit. rating";
		SI_IB_RANGEDCRIT = "Ranged Crit. rating";
		SI_IB_TOHIT = "Hit rating";
	else
	...
	if (SI_RunningWoW2) then
		SI_IB_SPELLCRIT = "Spell Crit. rating";
		SI_IB_SPELLTOHIT 	= "Spell Hit rating";
		SI_IB_HOLYCRIT 	= "Holy Spell Crit. rating";	
		SI_IB_HEALCRIT = "Healing Crit. rating";
	else
	...
	--additional wow2.0 stuff!
	if (SI_RunningWoW2) then
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases attack power by (%d+)%.", effect = "ATTACKPOWER"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases ranged attack power by (%d+)%.", effect = "RANGEDATTACKPOWER"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your dodge rating by (%d+)%.", effect = "DODGE"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your block rating by (%d+)%.", effect = "BLOCK"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your parry rating by (%d+)%.", effect = "PARRY"});
		
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your hit rating by (%d+)%.", effect = "TOHIT"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your critical strike rating by (%d+)%.", effect = "CRIT"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases defense rating by (%d+)%.", effect = "DEFENSE"});
		
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your spell critical strike rating by (%d+)%.", effect = "SPELLCRIT"});
		table.insert(SI_IB_EQUIP_PATTERNS,{ pattern = "Increases your spell hit rating by (%d+)%.", effect = "SPELLTOHIT"});
	end	
...
if ( GetLocale() == "deDE" ) then
	...
	SI_HudClass = {
		["Magier"] =		{0,1,1},
		["Hexenmeister"] =	{0.55,0.33,0.98},
		["Priester"] =		{1,1,1},
		["Druide"] =		{1,0.54,0},
		["Schamane"] =		{1,0.44,0.66},
		["Paladin"] =		{1,0.44,0.66},
		["Schurke"] =		{1,1,0},
		["J\195\164ger"] =	{0,1,0},
		["Krieger"] =		{0.70,0.58,0.25},	
	};	
...
SI_DURABILITY = "Durabilit\195\169";
	...
	SI_HudClass = {
		["Mage"] =		{0,1,1},
		["D\195\169moniste"] =	{0.55,0.33,0.98},
		["Pr\195\170tre"] =		{1,1,1},
		["Druide"] =		{1,0.54,0},
		["Chaman"] =		{1,0.44,0.66},
		["Paladin"] =		{1,0.44,0.66},
...
if (SI_RunningWoW2) then
	SI_IB_EFFECTS = {
		{ effect = "STR",			name = SPELL_STAT1_NAME,		 	format = "+%d",			cat = "ATT" },
		{ effect = "AGI",			name = SPELL_STAT2_NAME, 			format = "+%d",			cat = "ATT" },
		{ effect = "STA",			name = SPELL_STAT3_NAME, 			format = "+%d",			cat = "ATT" },
		{ effect = "INT",			name = SPELL_STAT4_NAME, 			format = "+%d",			cat = "ATT" },
		{ effect = "SPI",			name = SPELL_STAT5_NAME,			format = "+%d",			cat = "ATT" },
