...
local vmajor,vminor = "0.4", tonumber(string.sub("$Revision: 15132 $", 12, -3))
...
function Detox:OnInitialize()
	...
	if not FuBar then
		self.OnMenuRequest.args.hide.guiName = GetLocale() == "koKR" and "미니맵 아이콘 숨김" or "Hide minimap icon"
		self.OnMenuRequest.args.hide.desc = GetLocale() == "koKR" and "미니맵 아이콘을 숨깁니다" or "Hide minimap icon"
	end
end
