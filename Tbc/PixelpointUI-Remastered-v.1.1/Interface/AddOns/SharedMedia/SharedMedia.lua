...
SharedMedia:Register("background", "EliteArt", [[Interface\Addons\SharedMedia\background\elite.tga]])
SharedMedia:Register("background", "RareArt", [[Interface\Addons\SharedMedia\background\rare.tga]])

-- -----
--  BORDER
-- ----
SharedMedia:Register("border", "RothSquare", [[Interface\Addons\SharedMedia\border\roth.tga]])
SharedMedia:Register("border", "PixelP", [[Interface\Addons\SharedMedia\border\PixelP.tga]])
